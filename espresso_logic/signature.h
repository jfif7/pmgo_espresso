...
/* black_white.c */ extern void variable_list_init(int reduced_c_free_count,
...
/* black_white.c */ extern void get_next_variable(int *pv, int *pphase,
                                                  pset_family R);
...
/* canonical.c */ extern pset_family find_canonical_cover(pset_family F1,
                                                          pset_family D,
                                                          pset_family R);
/* essentiality.c */ extern pset_family etr_order(pset_family F, pset_family E,
                                                  pset_family R, pset c,
                                                  pset d);
/* essentiality.c */ extern void aux_etr_order(pset_family F, pset_family E,
                                               pset_family R, pset c, pset d);
...
/* signature.c */ extern pset_family signature(pset_family F1, pset_family D1,
                                               pset_family R1);
/* signature.c */ extern pset_family generate_primes(pset_family F,
                                                     pset_family R);
/* signature_exact.c */ extern pset_family signature_minimize_exact(
    pset_family ESCubes, pset_family ESSet);
/* signature_exact.c */ extern sm_matrix *signature_form_table(
    pset_family ESCubes, pset_family ESSet);
