 ...
 *		3. Freer Binate
 */
pcover etr_order(pset_family F, pset_family E, pset_family R, pset c, pset d) {
 ...
 *	R: OFFSET cover;
 */
void aux_etr_order(pset_family F, pset_family E, pset_family R, pset c,
                   pset d) {
    pcover minterms;
    pcube d_minterm;
    pcube sigma_d;
