...
static void dump_irredundant(pset_family E, pset_family Rt, pset_family Rp,
                             sm_matrix *table);
static pcover do_minimize(pset_family F, pset_family D, pset_family R,
                          int exact_cover, int weighted);
...
pcover minimize_exact(pset_family F, pset_family D, pset_family R,
                      int exact_cover) {
    return do_minimize(F, D, R, exact_cover, /*weighted*/ 0);
}

pcover minimize_exact_literals(pset_family F, pset_family D, pset_family R,
                               int exact_cover) {
